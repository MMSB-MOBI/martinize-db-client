...
export function removeNodes(nodesToRemove: SimulationNode[], updateFunction: () => void, decreaseIDFunction: () => void) {
    console.log("remove : ", nodesToRemove.length , "nodes")
