...
export default function AddMoleculeFileInput(props: { 
  ...
  function addInput(type: 'itp' | 'map') {
    const id = String(Math.random());

    if (type === 'itp') {
      setItpFileInputs([...itpFileInputs, [id, null]]);
    }
    else {
      setMapFileInputs([...mapFileInputs, [id, null]]);
    }
  }
  ...
  return (
    <ThreeGrid enable={!!props.useGrid}>
      <div>
        ...
        <Typography gutterBottom>
          Original TOP file generated by Martinize
        </Typography>
        <div>
          <FileInput has={topInput ? topInput.name : ""} onFileChange={onTopChange} />
        </div>
      </div>
